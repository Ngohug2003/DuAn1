...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../views/assets/lib/bootstrap.min.css">
    <link rel="stylesheet" href="sty/sty.css">
    <script src="../views/assets/lib/bootstrap.bundle.min.js"></script>
    <script src="../views/assets/lib/font-fontawesome-ae333ffef2.js"></script>
                ...
                <div class="navbar navbar-expand  d-flex justify-content-between ">    
                    ...
                    <ul class="navbar-nav text-black-50">
                        ...
                        if(isset($_SESSION['username']) && $_SESSION['username'] != ""){
                            ...
                            echo '<li><a style="text-decoration: none; color:red ; font-size:20px" href="#">'. $username_user . '</a> | <a href="index.php?act=dangxuat"> <input class="btn btn-danger " type="submit" name="dangxuat" value="Đăng xuất"></a></li>';
                        }else{
                        ?>
        ...
        <div  class="container">
            <!-- <div class="collapse navbar-collapse "></div> -->
                <div class="navbar navbar-expand-lg text-black-50 d-flex justify-content-between">    
                    <a href="index.php"><img style="width: 70px; border-radius: 50%;" class="img-thumbnail" src="../views/assets/img/logo_computer.png" alt="Logo"></a>
    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../views/assets/img/banner1.jpg" alt="Los Angeles" class="d-block" style="width:100%">
          </div>
          <div class="carousel-item">
            <img src="../views/assets/img/banner1.jpg" alt="Chicago" class="d-block" style="width:100%">
          </div>
          <div class="carousel-item">
            <img src="../views/assets/img/banner1.jpg" alt="New York" class="d-block" style="width:100%">
          </div>
        </div>
