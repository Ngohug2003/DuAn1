                ...
                case 'addToCart': 
                    ...
                    case 'thanhtoan': 
                        ...
                        if(isset($_POST['thanhtoan']) && $_POST['thanhtoan'] ) {
                            ...
                            $iddh = taodonhang($username_user,$diachi_user,$phone_user,$email_user,$tongtien_donhang,$madh,$ngaydathang,$phuongthucthanhtoan);
                            ...
                            $thongbao = "<script>alert('Đặt hàng thành công, vui lòng đợi xác nhận đơn hàng!'); window.location.href = 'index.php';</script>";
